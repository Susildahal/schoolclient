...
import axiosInstance from "../../config/Axiosconfig";
 ...
 export const fetch = createAsyncThunk("fetch/userMessages",async()=>{
    try {
        const response = await axiosInstance.get("/notic/getallNotic");
...
export const save = createAsyncThunk("save/userMessage", async (messagedata) => {
    try {
        const response = await axiosInstance.post("/notic/savenotic", messagedata);
        return response.data.data;
    } catch (error) {
...
export const deletedata = createAsyncThunk("delete/userMessage", async (messageId) => {
    try {
        const response = await axiosInstance.delete(`/notic/deletedNotic/${messageId}`);
        return response.data.data;
    } catch (error) {
